...
class MotorRampExample:
	...
	while char != "j":
	    thrust = self._get_thrust(thrust, alt)
	    if thrust < (old_thrust - 7500) or thrust > (old_thrust + 7500): ## capping
		thrust = old_thrust
    ...
    def _get_thrust(self, thrust, target_alt):
	alt = self._getCurrentAltitude()
	if alt < target_alt:
	    return (thrust + 100)
	elif alt > target_alt:
...
if __name__ == '__main__':
	...
	msg = str(dt + ": " + "Total Flight Time: " + str(int(4.7 - 2.6)) + " seconds\n")
	fo.write(msg);
