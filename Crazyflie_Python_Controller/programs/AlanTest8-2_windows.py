...
class MotorRampExample:
    ...
    def _calibrate(self):
        ...
        while 1:
            ...
            ## Roll control
            if char == right_arrow: ## this is the right arrow on the keyboard translation
                print "moving right "
	        ...
	        ## Landing
            if char == 108: # letter l
                print "pressed l ==> landing..."
                l_char = self._getch()
                while current_thrust >= 15000 and l_char != enter_button:
